...
const SCENARIOS: Array<{
...
}> = [
  {
    ...
    icon: <CreditCard className="w-3.5 h-3.5 text-rose-500 dark:text-rose-400" />,
    badge: 'Critical',
  ...
  },
  {
    ...
    icon: <Truck className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400" />,
    badge: 'High',
  ...
  },
  {
    ...
    icon: <UtensilsCrossed className="w-3.5 h-3.5 text-rose-500 dark:text-rose-400" />,
    badge: 'Critical',
    badgeColor: 'text-rose-700 dark:text-rose-300 bg-rose-500/10 border-rose-300 dark:border-rose-500/20',
  },
  {
    ...
    icon: <ThumbsUp className="w-3.5 h-3.5 text-emerald-500 dark:text-emerald-400" />,
    badge: 'Low',
  ...
  },
  {
    ...
    icon: <Smartphone className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400" />,
    badge: 'Medium',
  ...
  return (
    <>
      ...
      <div className="relative inline-block text-left">
        ...
        {isOpen && (
          <div className="absolute right-0 mt-2 w-72 origin-top-right rounded-2xl bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 shadow-2xl p-2 z-50 animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-1">
              {SCENARIOS.map((sc) => (
                <button
                  ...
                  className="w-full flex items-center justify-between p-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-gray-800/80 text-left transition-colors group"
                >
                  <div className="flex items-center gap-2">
                    <div className="p-1.5 rounded-lg bg-slate-100 dark:bg-gray-950 border border-slate-200 dark:border-gray-800 group-hover:border-slate-300 dark:group-hover:border-gray-700">
                      {sc.icon}
                    </div>
                    <span className="text-xs font-semibold text-slate-800 dark:text-gray-200 group-hover:text-slate-950 dark:group-hover:text-white">
                      {sc.label}
                    </span>
                  </div>
      ...
      {isProcessing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 dark:bg-black/75 backdrop-blur-sm animate-in fade-in duration-150">
          <div className="relative w-full max-w-md bg-white dark:bg-gray-900 border border-indigo-200 dark:border-indigo-500/40 rounded-3xl shadow-2xl p-6 space-y-5 text-center">
            ...
            {/* Stepper Progress */}
            <div className="space-y-2 text-left bg-slate-50 dark:bg-gray-950 p-4 rounded-2xl border border-slate-200 dark:border-gray-800 text-xs">
              <div className="flex items-center gap-2">
                {processingStage >= 1 ? (
                ...
                <span className={processingStage >= 1 ? 'text-slate-900 dark:text-white font-medium' : 'text-slate-400 dark:text-gray-500'}>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={processingStage >= 2 ? 'text-slate-900 dark:text-white font-medium' : 'text-slate-400 dark:text-gray-500'}>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={processingStage >= 3 ? 'text-slate-900 dark:text-white font-medium' : 'text-slate-400 dark:text-gray-500'}>
      ...
      {toastReview && (
        <div className="fixed bottom-6 right-6 z-50 max-w-md w-full animate-in slide-in-from-bottom-5 duration-300">
          <div className="p-4 rounded-2xl bg-white dark:bg-gray-900 border border-rose-300 dark:border-rose-500/50 shadow-2xl shadow-rose-950/20 flex items-start justify-between gap-3">
            <div className="flex items-start gap-3">
              <div className="p-2 rounded-xl bg-rose-500/10 dark:bg-rose-500/20 text-rose-700 dark:text-rose-300 border border-rose-300 dark:border-rose-500/40 mt-0.5">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-rose-500/10 text-rose-700 dark:bg-rose-500/20 dark:text-rose-300 border border-rose-300 dark:border-rose-500/40">
                    URGENT
                  </span>
                </div>
                <p className="text-xs text-slate-700 dark:text-gray-200 font-medium">
            ...
            <button
              onClick={() => setToastReview(null)}
              className="p-1 rounded-lg text-slate-400 hover:text-slate-700 dark:text-gray-400 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-gray-800 transition-colors"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
